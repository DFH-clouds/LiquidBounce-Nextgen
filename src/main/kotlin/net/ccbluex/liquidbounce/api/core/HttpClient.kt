...
object HttpClient {
    ...
    @JvmField
    val DEFAULT_AGENT = "${LiquidBounce.CLIENT_NAME}/${LiquidBounce.version1}" + "Time:" +
        " (${LiquidBounce.clientCommit}, " +
        "${if (LiquidBounce.IN_DEVELOPMENT) "dev" else "dev"}, ${System.getProperty("os.name")})"
